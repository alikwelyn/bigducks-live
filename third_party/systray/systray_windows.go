...
// Modified by BIG DUCKS contributors to support modern Windows tray notifications.
...
func isMenuNotification(lParam uintptr) bool {
	switch uint32(lParam & 0xffff) {
	case wmContextMenu, wmLButtonUp, wmRButtonUp, ninSelect, ninKeySelect:
		return true
	default:
		return false
	}
